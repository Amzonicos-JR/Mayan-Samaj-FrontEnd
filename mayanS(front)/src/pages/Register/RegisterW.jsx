...
export const RegisterW = () => {
    ...
    const registerW = async (e) => {
        try {
            ...
            const { data } = await axios.post('http://localhost:3000/user/registerW', user, { headers: headers })
            alert(`${data.message}`)
            clear();
            navigate('/login')
        } catch (err) {
            ...
            <section className="d-flex justify-content-center align-items-center" style={{ margin: "40px" }}>
                <div className="card shadow col-xs-12 col-sm-6 col-md-6 col-lg-4   p-4">
                    <div className="mb-4 d-flex justify-content-start align-items-center">
                        <h4> <i className="bi bi-person-square"></i> &nbsp; Register Worker</h4>
                    </div>
                    <div className="mb-1">
                        <form id="contacto">
                            <div className="mb-4 ">
                            ...
                            <div className="mb-4 d-flex align-items-center">
                                <div className="mb-2">
                                    <a onClick={(e) => registerW(e)}  className="col-11 btn btn-primary d-flex justify-content-between"
