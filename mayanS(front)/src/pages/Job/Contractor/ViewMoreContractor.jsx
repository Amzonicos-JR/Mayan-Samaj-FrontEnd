  ...
  return (
    <>
      ...
      <div className="d-flex justify-content-center d-flex flex-wrap">
        <div className="m-4 hover2" style={{ width: "80vw" }}>
          <ul className="list-group list-group-flush">
            <li className="list-group status">
                ...
                <li className="list-group">
                  <div className="card-body">
                    <h5 className="card-title">
                      Worker: {job.request.worker.name}{" "}
                      {job.request.worker.surname}
                    </h5>
                    <h5 className="card-text">
                      Duration of Work: {job.request.duration}
                    </h5>
                    <h5 className="card-text">
                      Phone: {job.request.worker.phone}
                    </h5>
                    <h5 className="card-text">
                      Email: {job.request.worker.email}
                    </h5>
                    <h5 className="card-text">Status: {job.request.status}</h5>
                  </div>
                </li>
              </ul>
            </>
            ...
            <>
              <ul className="list-group list-group-flush">
                <li className="list-group">
                  <div className="card-body">
                    <h5 className="card-text">
                      Contractor: {job.request.worker.name}{" "}
                      {job.request.worker.surname}
                    </h5>
                    <h5 className="card-text">
      ...
      {job.status === "InProgress" ? (
        <>
          <h1 className="position-relative d-flex justify-content-center d-flex flex-wrap containerButtonFinalizar">
            <div>
              <button
                type="button"
